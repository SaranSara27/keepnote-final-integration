...
public class CategoryServiceImplTest {
	...
	/*
	 * @Test public void getAllCategoryByUserIdTestSuccess() {
	 * when(categoryRepository.findAllCategoryByCategoryCreatedBy(category.
	 * getCategoryCreatedBy())).thenReturn(allCategories); List<Category> categories
	 * = categoryServiceImpl.getAllCategoryByUserId("Jhon123");
