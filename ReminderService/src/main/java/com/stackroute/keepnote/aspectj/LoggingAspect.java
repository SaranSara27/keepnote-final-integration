...
public class LoggingAspect {
	...
	public void logBeforeGetReminder(JoinPoint joinpoint) {
		log.info("====================@Before==========================");
	...
	public void logAfterGetReminder(JoinPoint joinpoint) {
		log.info("====================@After==========================");
		log.debug("Method Name:" + joinpoint.getSignature().getName());
	...
	public void logAfterReturningGetReminder(JoinPoint joinpoint,Object result) {
	...
	@AfterThrowing(pointcut="execution(* com.stackroute.keepnote.controller.ReminderController.*(..))",throwing="error")
	public void logAfterThrowingGetReminder(JoinPoint joinpoint,Throwable error) {
